...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '夯AI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '告訴你最夯的AI用法', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://popularai.vercel.app', // 网站地址
